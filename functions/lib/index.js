...
exports.sendWeeklyDigest = exports.triggerWeeklyManualCheck = exports.checkDeadlineUpdates = exports.createSource = void 0;
...
exports.createSource = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
...
exports.triggerWeeklyManualCheck = functions.pubsub.schedule('every sunday 09:00')
    .timeZone('America/New_York')
    .onRun(async (context) => {
...
exports.sendWeeklyDigest = functions.pubsub.schedule('every monday 08:00')
    .timeZone('America/New_York')
    .onRun(async (context) => {
    ...
    for (const userDoc of usersSnap.docs) {
        ...
        if (changed.length === 0 && needsCheck.length === 0)
            continue;
        const html = `
         <h3>Weekly Digest</h3>
